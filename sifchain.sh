#!/bin/bash
CHAIN_ID="sifchain-1"
SNAP_PATH="$HOME/nginx/cosmos-snapshots/sifchain/"
LOG_PATH="$HOME/nginx/cosmos-snapshots/sifchain/sifchain_log.txt"
DATA_PATH="$HOME/.sifnoded/data/"
SERVICE_NAME="sifnoded.service"
RPC_ADDRESS="http://127.0.0.1:26666"
