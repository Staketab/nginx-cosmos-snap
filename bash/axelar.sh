...
SNAP_PATH="$HOME/nginx/cosmos-snapshots/axelar/"
LOG_PATH="$HOME/nginx/cosmos-snapshots/axelar/axelar-dojo-1_log.txt"
DATA_PATH="$HOME/.axelar/data/"
SERVICE_NAME="axelard.service"
RPC_ADDRESS="http://127.0.0.1:16657"
